...
(function (global, factory) {
  ...
  if (HTMLElement.prototype.remove === void 0 || window.customElements === void 0 || window.Reflect === void 0) {
    ...
    if (window.customElements === void 0) console.warn("This can be fixed by adding 'https://unpkg.com/@webcomponents/webcomponentsjs@2.3.0/webcomponents-loader.js' before loading 'scarletsframe.js'");
    if (window.Reflect === void 0) console.warn("This can be fixed by adding 'https://unpkg.com/core-js-bundle@3.4.0/minified.js' before loading 'scarletsframe.js'");
    alert("This browser was not supported");
  } // Dynamic script when using router to load template
  // Feature is disabled by default


  function routerEval(code) {
    eval(code);
  }

  if (typeof exports === 'object' && typeof module !== 'undefined') module.exports = factory(global, routerEval);else global.sf = factory(global, routerEval);
})(typeof window !== "undefined" ? window : this, function (window, routerEval) {
  //'use strict';
  if (typeof document === void 0) document = window.document; // ===== Module Init =====

  var internal = {};

  var sf = function sf(stuff) {
    if (stuff.constructor === Function) return sf.loader.onFinish.apply(null, arguments); // If it's Node type

    if (stuff.tagName !== void 0) return sf.model.root[sf.controller.modelName(stuff)];
  };
  ...
  sf.dom = function (selector, context) {
    if (!selector) {
      if (selector === void 0) {
        var temp = function temp(sel) {
          return temp.find(sel);
        }; // We need to support IE 11


        temp.length = 0; // Object.defineProperty(temp, 'length', {writable:true, enumerable:false, value:0});

        return Object.assign(temp, DOMList.prototype);
      } else return new DOMList([]);
    } else if (selector.constructor === Function) return sf(selector);else if (selector[0] === '<' || selector[selector.length - 1] === '>') return new DOMList(sf.dom.parseElement(selector));else if (context) return new DOMList(context.querySelectorAll(selector));else if (selector.constructor === String) return new DOMList(document.querySelectorAll(selector));
  ...
  (function () {
    ...
    var css_strRep = function css_strRep(f, m) {
    ...
    self.fn = DOMList.prototype = {
      ...
      indexOf: function indexOf(el) {
        ...
        for (var i = 0; i < keys.length; i++) {
          if (this[keys[i]] === el) return i;
        }

        return -1;
      },
      splice: function splice(i) {
      ...
      parent: function parent(selector) {
        if (this.length === 1) {
          if (selector) return new DOMList(self.parent(this[0], selector));
      ...
      hasClass: function hasClass(name) {
        for (var i = 0; i < this.length; i++) {
          if (this[i].classList.contains(name)) return true;
        }

        return false;
      },
      prop: function prop(name, value) {
        if (value === void 0) return this.length !== 0 ? this[0][name] : '';
      ...
      attr: function attr(name, value) {
        if (value === void 0) return this.length !== 0 ? this[0].getAttribute(name) : '';
      ...
      css: function css(name, value) {
        if (value === void 0 && name.constructor === String) return this.length !== 0 ? this[0].style[name] : '';

        if (name.constructor === Object) {
          var keys = Object.keys(name);

          for (var i = 0; i < keys.length; i++) {
            if (/\-/.test(keys[i]) !== true) continue;
      ...
      off: function off(event, selector, callback) {
        for (var i = 0; i < this.length; i++) {
          if (internal.model.specialEvent[event] !== void 0) {
            if (this[i]['sf$eventDestroy_' + event] !== void 0) this[i]['sf$eventDestroy_' + event]();
            continue;
          }
      ...
      once: function once(event, selector, callback) {
        for (var i = 0; i < this.length; i++) {
      ...
      trigger: function trigger(events, data, direct) {
        events = events.split(' ');
      ...
      animateKey: function animateKey(name, callback, duration) {
        for (var i = 0; i < this.length; i++) {
      ...
      data: function data(key, value) {
        if (value === void 0) return this.length !== 0 && this[0].$data ? this[0].$data[key] : void 0;

        for (var i = 0; i < this.length; i++) {
          if (this[i].$data === void 0) this[i].$data = {};
      ...
      removeData: function removeData(key) {
        for (var i = 0; i < this.length; i++) {
          if (this[i].$data === void 0) continue;
      ...
      append: function append(element) {
        if (element.constructor === Array || element.constructor === Object) {
          ...
          if (element.constructor === String) this[0].insertAdjacentHTML('beforeEnd', element);else this[0].append(element);
        }
      ...
      prepend: function prepend(element) {
        if (element.constructor === Array || element.constructor === Object) {
          ...
          if (element.constructor === String) this[0].insertAdjacentHTML('afterBegin', element);else this[0].prepend(element);
        }
      ...
      text: function text(_text) {
        if (_text === void 0) return this.length !== 0 ? this[0].innerText : '';
      ...
      html: function html(text) {
        if (text === void 0) return this.length !== 0 ? this[0].innerHTML : '';
      ...
      val: function val(text) {
        if (text === void 0) return this.length !== 0 ? this[0].value : '';
    ...
    Object.assign(self.fn, {
      click: function click(d) {
        return this.trigger('click', d, true);
      },
      blur: function blur(d) {
        return this.trigger('blur', d, true);
      },
      focus: function focus(d) {
        return this.trigger('focus', d, true);
      },
      focusin: function focusin(d) {
        return this.trigger('focusin', d);
      },
      focusout: function focusout(d) {
        return this.trigger('focusout', d);
      },
      keyup: function keyup(d) {
        return this.trigger('keyup', d);
      },
      keydown: function keydown(d) {
        return this.trigger('keydown', d);
      },
      keypress: function keypress(d) {
        return this.trigger('keypress', d);
      },
      submit: function submit(d) {
        return this.trigger('submit', d);
      },
      change: function change(d) {
        return this.trigger('change', d);
      },
      mousedown: function mousedown(d) {
        return this.trigger('mousedown', d);
      },
      mousemove: function mousemove(d) {
        return this.trigger('mousemove', d);
      },
      mouseup: function mouseup(d) {
        return this.trigger('mouseup', d);
      },
      mouseenter: function mouseenter(d) {
        return this.trigger('mouseenter', d);
      },
      mouseleave: function mouseleave(d) {
        return this.trigger('mouseleave', d);
      },
      mouseout: function mouseout(d) {
        return this.trigger('mouseout', d);
      },
      mouseover: function mouseover(d) {
        return this.trigger('mouseover', d);
      },
      touchstart: function touchstart(d) {
        return this.trigger('touchstart', d);
      },
      touchend: function touchend(d) {
        return this.trigger('touchend', d);
      },
      touchmove: function touchmove(d) {
        return this.trigger('touchmove', d);
      },
      resize: function resize(d) {
        return this.trigger('resize', d, true);
      },
      scroll: function scroll(d) {
        return this.trigger('scroll', d, true);
      }
    });
    ...
    self.parentHasProperty = function (element, propertyName) {
      do {
        if (element[propertyName] !== void 0) return element;
    ...
    self.prevAll = function (element, selector, isNext) {
      var result = [];
      var findNodes = !selector || selector.constructor !== String ? true : false; // Skip current element

      element = isNext ? element.nextSibling : element.previousSibling;

      while (element !== null) {
        if (findNodes === false) {
          if (element.matches(selector) === true) result.push(element);
        } else {
    ...
    self.on = function (element, event, selector, callback, once) {
      ...
      if (selector) {
        ...
        callback = function callback(ev) {
          ...
          if (target !== null) tempCallback.apply(target, [ev]);
        };
      ...
      if (once) return; // Save event listener

      if (element.sf$eventListener === void 0) element.sf$eventListener = {};
      if (element.sf$eventListener[event] === void 0) element.sf$eventListener[event] = [];
    ...
    self.off = function (element, event, selector, callback) {
      // Remove all event
      if (event === void 0) {
        if (element.sf$eventListener === void 0) return;
      ...
      if (element.sf$eventListener === void 0) {
        if (callback !== void 0) element.removeEventListener(event, callback, {
          capture: true
        });
        return;
      }
      ...
      if (callback) {
        ...
        if (ref !== void 0 && ref[event] !== void 0) {
          for (var i = ref[event].length - 1; i >= 0; i--) {
            ...
            element.removeEventListener(event, ref[event].splice(i, 1), {
              capture: true
            });
          }
        }
    ...
    self.animateKey = function (element, animationName, duration, callback) {
      ...
      if (duration === void 0 || duration.constructor === Number) duration = {
        duration: duration && duration.constructor === Number ? duration : 0.6,
        ease: 'ease',
        fill: 'both'
      };
      if (duration.skipOnHidden && (element.offsetParent === null || window.getComputedStyle(element).visibility === 'hidden')) return;
      var animationEnd = null;
      if (element.style.animation !== void 0) animationEnd = 'animationend';
      if (element.style.WebkitAnimation !== void 0) animationEnd = 'webkitAnimationEnd';
      var style = element.style;
      var arrange = animationName;
      if (duration.duration !== void 0) arrange += ' ' + duration.duration + 's';
      if (duration.ease !== void 0) arrange += ' ' + duration.ease;

      if (duration.delay !== void 0) {
        arrange += ' ' + duration.delay + 's';
        if (animationEnd === 'animationend') var animationStart = 'animationstart';else var animationStart = 'webkitAnimationStart';
        ...
        self.once(element, animationStart, function () {
          ...
          if (duration.whenBegin) duration.whenBegin();
          element.classList.remove('anim-pending');
          style.visibility = 'visible';
        });
      } else style.visibility = 'visible';

      if (duration.iteration !== void 0) arrange += ' ' + duration.iteration;
      if (duration.direction !== void 0) arrange += ' ' + duration.direction;
      if (duration.fill !== void 0) arrange += ' ' + duration.fill;
    ...
    self.remove = function (elements) {
      if (elements.remove !== void 0) return elements.remove();
      ...
      while (element.parentNode !== null) {
        if (element.id && !haveSymbol.test(element.id)) {
          ...
          if (element === untilElement) {
            if (childIndexes === void 0) names.unshift(element.tagName);else names.unshift(0);
          } else {
            var e = element;
    ...
    self.childIndexes = function (array, context) {
      ...
      var i = 1;
      if (array[0].constructor === String && element.id !== array[0].substr(1)) element = element.querySelector(array[0]);else if (array.length === 1) return element;
  ...
  sf.loader = new function () {
    ...
    var whenDOMReady = [];
    var whenDOMLoaded = [];
    var whenProgress = []; // Make event listener
    ...
    function waitResources() {
      ...
      self.turnedOff = true; // Initialize all pending model

      var keys = Object.keys(internal.modelPending);

      for (var i = 0; i < keys.length; i++) {
        var ref = internal.modelPending[keys[i]];
        if (sf.model.root[keys[i]] === undefined) var scope = sf.model.root[keys[i]] = {};else var scope = sf.model.root[keys[i]];
  ...
  sf.component = new function () {
    ...
    self.for = function (name, func, extend) {
      if (self.registered[name] === void 0) self.registered[name] = [func, sf.controller.pending[name], 0, false, extend];
    ...
    self.html = function (name, outerHTML) {
      if (self.registered[name] === void 0) self.registered[name] = [false, false, 0, false];
      var temp = $.parseElement(outerHTML);
      if (temp.length === 1) self.registered[name][3] = temp[0];else {
      ...
      if (waitingHTML[name] === void 0) return;
      ...
      for (var i = upgrade.length - 1; i >= 0; i--) {
        ...
        if (el.model.init) el.model.init();
      }
    };
    ...
    self.new = function (name, element, $item) {
      if (internal.component.skip) return;
      ...
      if (element.childElementCount === 0) {
        if (self.registered[name][3] === false) {
          if (waitingHTML[name] === void 0) waitingHTML[name] = [];
          waitingHTML[name].push({
            el: element,
            item: $item
          });
          return;
      ...
      if (element.sf$componentIgnore === true) return;
      var avoid = /(^|:)(sf-|class|style)/;
      var attr = element.attributes;
      if (attr.length !== 0 && $item === void 0) $item = {};

      for (var i = 0; i < attr.length; i++) {
        if (avoid.test(attr[i].nodeName)) continue;
      ...
      if (self.available[name] === void 0) self.available[name] = [];
      ...
      if (self.registered[name][1]) self.registered[name][1](newObj, sf.model, $item);

      if (element.childElementCount === 0) {
        var temp = self.registered[name][3];
        var tempDOM = temp.tempDOM; // Create template here because we have the sample model
    ...
    function defineComponent(name) {
      ...
      var tagName = name;
      name = name.split('-');
      if (name.length === 1) return console.error("Please use '-' when defining component tags");
      name = capitalizeLetters(name); // Create function at current scope
      ...
      func.prototype.connectedCallback = function () {
        ...
        if (this.model.reinit) this.model.reinit();
      };

      func.prototype.disconnectedCallback = function () {
        if (this.sf$componentIgnore) return;
        ...
        this.sf$destroying = setTimeout(function () {
          if (!that.model) return console.log(that);
          if (that.model.destroy) that.model.destroy();
  ...
  sf.model = function (scope) {
    ...
    if (sf.component.registered[scope] !== void 0) return root_(scope);
  ...
  (function () {
    var self = sf.model;
    self.root = {};
    internal.modelPending = {}; // Find an index for the element on the list

    self.index = function (element) {
      if (element.hasAttribute('sf-bind-list') === false) element = sf.dom.parent(element, '[sf-bind-list]');
      var i = -1;
    ...
    self.for = function (name, func) {
      if (!sf.loader.DOMWasLoaded) {
        if (internal.modelPending[name] === undefined) internal.modelPending[name] = [];
        if (internal.modelPending[name] === false) return func(self(name), self); // Initialize when DOMLoaded
  ...
  function (_HTMLElement) {
    _inheritsLoose(SFModel, _HTMLElement);

    function SFModel() {
      var _this;

      _this = _HTMLElement.call(this) || this;
      _this.sf$firstInit = true;
      return _this;
    }

    var _proto = SFModel.prototype;

    _proto.connectedCallback = function connectedCallback() {
      if (this.sf$destroying !== void 0) clearTimeout(this.sf$destroying);
      if (this.sf$firstInit === void 0) return;
      var that = this;
      delete this.sf$firstInit;
      setTimeout(function () {
        if (sf.loader.DOMWasLoaded) return sf.model.init(that, that.getAttribute('name'));
  ...
  (function () {
    ...
    self.init = function (el, modelName) {
      if (el.sf$controlled !== void 0) return;
      el.sf$controlled = modelName;
      var model = el.model = sf.model.root[modelName] || sf.model(modelName);
      if (model.$el === void 0) model.$el = $();
      model.$el.push(el);
      if (sf.controller.pending[modelName] !== void 0) sf.controller.run(modelName);
      var specialElement = {
        repeat: [],
        input: []
      };
      ...
      if (model.init !== void 0) model.init(el);
    ...
    var scope = internal.model = {}; // For debugging, normalize indentation
    ...
    var localEval = function localEval(script, _model_, _modelScope, _content_) {
      ...
      try {
        if (/@return /.test(script) === true) {
          ...
          if (_evaled_ === void 0) return _result_ + 'undefined';
          if (_evaled_ === null) return _result_ + 'null'; // Check if it's an HTMLElement

          if (_evaled_.onclick !== void 0) return _evaled_;
    ...
    internal.model.removeModelBinding = function (ref, noBackup) {
      ...
      for (var key in bindedKey) {
        if (bindedKey[key] === null) continue;

        for (var i = bindedKey[key].length - 1; i >= 0; i--) {
          if (!bindedKey[key][i].element.isConnected) bindedKey[key].splice(i, 1);
        }

        if (bindedKey[key].input !== void 0) for (var i = bindedKey[key].input.length - 1; i >= 0; i--) {
          if (!bindedKey[key].input[i].isConnected) bindedKey[key].input.splice(i, 1);
        }
        ...
        if (bindedKey[key].length === 0) {
          ...
          if (Object.getOwnPropertyDescriptor(ref, key) === void 0) continue; // Reconfigure / Remove property descriptor
    ...
    function modelToViewBinding(model, propertyName, callback, elementBind, type) {
      ...
      if (model.sf$bindedKey === void 0) initBindingInformation(model);

      if (model.sf$bindedKey[propertyName] !== void 0) {
        var ref = model.sf$bindedKey[propertyName];
        if (ref.indexOf(callback) === -1) ref.push(callback);
      ...
      if (Object.getOwnPropertyDescriptor(model, propertyName).set !== void 0) return;
      var objValue = model[propertyName]; // Object value

      Object.defineProperty(model, propertyName, {
        enumerable: true,
        configurable: true,
        get: function get(getAssigner) {
          return objValue;
        },
        set: function set(val) {
          if (objValue !== val) {
            ...
            if (inputBoundRunning === false) {
              ...
              try {
                if (on !== void 0) newValue = on(objValue, val);
                if (out !== void 0) newValue = out(objValue, val);
              } catch (e) {
                console.error(e);
              }
            }
            ...
            } else objValue = newValue !== void 0 ? newValue : val;
            ...
            for (var i = 0; i < ref.length; i++) {
              ...
              if (syntheticTemplate(ref[i].element, ref[i].template, void 0, model) === false) 0; //No update
            }

            if (m2v !== void 0) objValue = m2v;
          }
    ...
    self.bindElement = function (element, modelName, template) {
      ...
      if (template === void 0) {
        ...
        delete template.addresses; // console.warn(42, template.html, element);
      ...
      for (var i = 0; i < properties.length; i++) {
        ...
        if (model[propertyName] === void 0) model[propertyName] = '';
    ...
    function eventHandler(that, data, _modelScope) {
      ...
      script = avoidQuotes(script, function (script_) {
        if (/[ =(+-]/.test(script_) === false) direct = true; // Replace variable to refer to current scope
      ...
      if (keys.has('passive')) {
        if (keys.has('prevent')) console.error("Can't preventDefault when using passive listener", that);
      ...
      if (eventName.indexOf('mouse') === 0) {
        eventName = 'pointer' + eventName.slice(5); // Prevent context menu on mouse event

        if (keys.has('right')) that.addEventListener('contextmenu', function (ev) {
          ev.preventDefault();
        }, options);
      }
      ...
      if (direct && keys.size === 0) var callback = script;else {
        var callback = function callback(ev) {
          if (!keys.has('bot') && ev.isTrusted === false) return;
          if (keys.has('stop')) ev.stopPropagation();

          if (ev.ctrlKey !== void 0) {
            if (ev.ctrlKey !== keys.has('ctrl') || ev.altKey !== keys.has('alt') || ev.shiftKey !== keys.has('shift') || ev.metaKey !== keys.has('meta')) return;
          }

          if (ev.constructor === KeyboardEvent) {
            if (containSingleChar && !keys.has(ev.key)) return;
            ev.preventDefault();
          }
          /*
          ...
          */
              ...
              if (!(ev.buttons & 1) && keys.has('left') || !(ev.buttons & 2) && keys.has('right') || !(ev.buttons & 4) && keys.has('middle') || !(ev.buttons & 8) && keys.has('4th') || !(ev.buttons & 16) && keys.has('5th')) return;
              ev.preventDefault();
            } else if (ev.constructor === TouchEvent) {
              if (containSingleChar && !keys.has(ev.touches.length)) return;
              ev.preventDefault();
            } else if (keys.has('prevent')) ev.preventDefault();

          if (direct) return script.call(this, ev);
          var that = this;
          eval(script);
        };
      }
    ...
    var specialEvent = internal.model.specialEvent = {
      taphold: function taphold(that, keys, script, _modelScope) {
        var set = new Set();
        var evStart = null;

        function callback() {
          that.removeEventListener('pointerup', callbackEnd, {
            once: true
          });
          that.removeEventListener('pointercancel', callbackEnd, {
            once: true
          });
          document.removeEventListener('pointermove', callbackMove);
          set.delete(evStart.pointerId);
          if (script.constructor === Function) return script.call(that, evStart);
          eval(script);
        }
        ...
        function callbackStart(ev) {
          ...
          that.addEventListener('pointerup', callbackEnd, {
            once: true
          });
          that.addEventListener('pointercancel', callbackEnd, {
            once: true
          });
      ...
      gesture: function gesture(that, keys, script, _modelScope) {
        touchGesture(that, function callback(data) {
          if (script.constructor === Function) return script.call(that, data);
          eval(script);
        });
      },
      dragmove: function dragmove(that, keys, script, _modelScope) {
        var length = 0;
        var actionBackup = '';
        ...
        function callbackMove(ev) {
          ev.stopPropagation();
          ev.preventDefault();
          if (script.constructor === Function) return script.call(that, ev);
          eval(script);
        }

        var callbackStart = function callbackStart(ev) {
          ev.preventDefault();
        ...
        var callbackEnd = function callbackEnd(ev) {
          ev.preventDefault();
    ...
    function touchGesture(that, callback) {
      ...
      function findAnd(action, ev) {
        for (var i = 0; i < pointers.length; i++) {
          if (pointers[i].pointerId === ev.pointerId) {
            if (action === 2) // delete
              pointers.splice(i, 1);else if (action === 1) // replace
      ...
      var callbackStart = function callbackStart(ev) {
        ...
        if (pointers.length === 2) {
          ...
          lastScale = startScale = Math.sqrt(Math.pow(dx, 2) + Math.pow(dy, 2)) * 0.01;
          lastAngle = startAngle = Math.atan2(dy, dx) * 180 / Math.PI;
          document.addEventListener('pointermove', callbackMove);
        } else document.removeEventListener('pointermove', callbackMove);
      };

      var callbackMove = function callbackMove(ev) {
        ev.preventDefault();
        ev.stopPropagation();
        findAnd(1, ev);
        var dx = pointers[1].clientX - pointers[0].clientX;
        var dy = pointers[1].clientY - pointers[0].clientY;
        var currentScale = Math.sqrt(Math.pow(dx, 2) + Math.pow(dy, 2)) * 0.01;
      ...
      var callbackEnd = function callbackEnd(ev) {
        ...
        if (pointers.length <= 1) {
          ...
          document.addEventListener('pointerup', callbackEnd);
          document.addEventListener('pointercancel', callbackEnd);
          if (pointers.length === 2) document.removeEventListener('pointermove', callbackMove);
        }
      };
      ...
      var keyEnd = function keyEnd(ev) {
        if (!force || ev.ctrlKey) return;
        force = false;
        pointers.length = 0;
        document.removeEventListener('pointermove', callbackMove);
      ...
      var keyStart = function keyStart(ev) {
    ...
    var callInputListener = function callInputListener(model, property, value) {
      var on = model['on$' + property];
      var v2m = model['v2m$' + property];
      var newValue1 = void 0;
      var newValue2 = void 0;

      if (on !== void 0 || v2m !== void 0) {
        var old = model[property];
        if (old !== null && old !== void 0 && old.constructor === Array) old = old.slice(0);

        try {
          if (v2m !== void 0) newValue1 = v2m(old, value);
          if (on !== void 0) newValue2 = on(old, value);
        } catch (e) {
          console.error(e);
        }
      }
    ...
    var inputTextBound = function inputTextBound(e) {
      ...
      if (newValue !== void 0) ref.sfModel[ref.sfBounded] = newValue;else ref.sfModel[ref.sfBounded] = value;
    };

    var inputFilesBound = function inputFilesBound(e) {
      if (e.fromSFFramework === true) return;
      var ref = e.target;
    ...
    var inputCheckBoxBound = function inputCheckBoxBound(e) {
      if (e.fromSFFramework === true) return;
      var ref = inputBoundRunning = e.target;
      ref.viewInputted = true;
      var value = ref.typeData === Number ? Number(ref.value) : ref.value;
      ...
      if (constructor === Array) {
        ...
        if (i === -1 && ref.checked === true) model[ref.sfBounded].push(value);else if (i !== -1 && ref.checked === false) model[ref.sfBounded].splice(i, 1);
      } else if (constructor === Boolean || ref.typeData === Boolean) model[ref.sfBounded] = ref.checked;else model[ref.sfBounded] = value;
    };

    var inputSelectBound = function inputSelectBound(e) {
      if (e.fromSFFramework === true) return;
      var ref = inputBoundRunning = e.target;
      ref.viewInputted = true;
    ...
    var assignElementData = {
      select: function select(val, element) {
        ...
        for (var i = 0, n = list.length; i < n; i++) {
          if (arrayValue === false) {
            if (typeData === String) list[i].selected = list[i].value === val;else list[i].selected = list[i].value == val;
          } else list[i].selected = arrayValue.indexOf(typeData === Number ? Number(list[i].value) : list[i].value) !== -1;
        }
      },
      checkbox: function checkbox(val, element) {
        if (val.constructor === Array) element.checked = val.indexOf(element.typeData === Number ? Number(element.value) : element.value) !== -1;else if (val.constructor === Boolean) element.checked = Boolean(val);else {
          if (element.typeData === String) element.checked = element.value === val;else element.checked = element.value == val;
        }
      }
    };

    var inputBoundRun = function inputBoundRun(val, elements) {
      if (val !== 0 && !val) return;

      for (var i = 0; i < elements.length; i++) {
        if (inputBoundRunning === elements[i]) continue; // Avoid multiple assigment

        var ev = new Event('change');
        ev.fromSFFramework = true;
        if (elements.type === 1) // text
          elements[i].value = val;else if (elements.type === 2) // select options
          assignElementData.select(val, elements[i]);else if (elements.type === 3) // radio
          elements[i].checked = val == elements[i].value;else if (elements.type === 4) // checkbox
          assignElementData.checkbox(val, elements[i]);
        elements[i].dispatchEvent(ev);
      }
    };

    var triggerInputEvent = function triggerInputEvent(e) {
      if (e.fromSFFramework === true) return;
    ...
    var elementBoundChanges = function elementBoundChanges(model, property, element, oneWay) {
      // Enable multiple element binding
      if (model.sf$bindedKey === void 0) initBindingInformation(model);
      var val = model[property];
      var type = 0;
      var typeData = null;
      if (val !== null && val !== void 0) typeData = val.constructor;
      var assignedType = (element.getAttribute('typedata') || '').toLowerCase();
      if (assignedType === 'number') typeData = Number;
      element.typeData = typeData;
      $.on(element, 'change', triggerInputEvent); // Bound value change
    ...
    var bindInput = internal.model.bindInput = function (temp, modelScope) {
      for (var i = 0; i < temp.length; i++) {
        ...
        if (propertyName === "") propertyName = element.getAttribute('name');
    ...
    var dataParser = function dataParser(html, _model_, mask, _modelScope, runEval, preParsedReference) {
      if (!runEval) runEval = '';
      var modelKeys = self.modelKeys(_modelScope).join('|');
      if (modelKeys.length === 0) throw "The model was not found"; // Don't match text inside quote, or object keys

      var scopeMask = RegExp(sf.regex.strictVar + '(' + modelKeys + ')\\b', 'g');
      if (mask) var itemMask = RegExp(sf.regex.strictVar + mask + '\\.\\b', 'g');
      bindingEnabled = true;
      ...
      var prepared = html.replace(sf.regex.dataParser, function (actual, temp) {
        temp = avoidQuotes(temp, function (temp_) {
          // Unescape HTML
          temp_ = temp_.split('&amp;').join('&').split('&lt;').join('<').split('&gt;').join('>'); // Mask item variable

          if (mask) temp_ = temp_.replace(itemMask, function (matched) {
        ...
        }).split('_model_._modelScope.').join('_model_.'); // Evaluate
    ...
    var uniqueDataParser = function uniqueDataParser(html, _model_, mask, _modelScope, runEval) {
      // Get prepared html content
      var _content_ = {
        length: 0,
        _modelScope: _modelScope,
        take: function take(passVar, currentIndex) {
          if (passVar === null) return dataParser(this[currentIndex], _model_, mask, this._modelScope); // Use strict mode and prepare for new variables

          var strDeclare = '"use strict";var ';
          var firstTime = true; // Declare new variable

          for (var key in passVar) {
            if (typeof passVar[key] === 'string') passVar[key] = '"' + passVar[key].split('"').join('\\"') + '"';else if (key === '_model_') {
              _model_ = passVar[key];
              continue;
            } else if (typeof passVar[key] === 'object') passVar[key] = JSON.stringify(passVar[key]);
      ...
      var prepared = html.replace(sf.regex.uniqueDataParser, function (actual, temp) {
        ...
        if (check.length !== 1) {
          ...
          var findElse = function findElse(text) {
            text = text.join(':');
            var else_ = null; // Split elseIf

            text = text.split('@elseif '); // Get else value
    ...
    self.extractPreprocess = function (targetNode, mask, modelScope) {
      ...
      if (mask !== null) copy = copy.split('#' + mask).join('_model_'); // Extract data to be parsed
      ...
      function findModelProperty() {
        ...
        for (var i = 0; i < preParsed.length; i++) {
          var current = preParsed[i]; // Text or attribute
          ...
          if (current.type === 0) {
            current.data[0].split('"').join("'").replace(extract, function (full, match) {
              ...
              if (found[match] === void 0) found[match] = [i];else if (found[match].indexOf(i) === -1) found[match].push(i);
            });
            continue;
          } // Dynamic data
          ...
          if (current.type === 1) {
            ...
            if (current.elseValue !== null) checkList += ';' + current.elseValue;

            for (var a = 0; a < current.elseIf.length; a++) {
              checkList += current.elseIf[a].join(';');
            }
          } else if (current.type === 2) var checkList = current.data[0];
      ...
      internal.component.skip = false; // Restore element repeated list
      ...
      function addressAttributes(currentNode) {
        ...
        for (var a = attrs.length - 1; a >= 0; a--) {
          ...
          if (found.length !== 1) {
            ...
            if (found === '' && indexes.length === 1) key.direct = indexes[0];else key.parse_index = indexes;
            keys.push(key);
          }
        }
      ...
      for (var i = 0; i < nodes.length; i++) {
        ...
        if (temp.nodeType === 1) {
          ...
          if (indexes.length !== 0) {
            ...
            var nextSibling = nodes[i].nextSibling; // Dynamic boundary start

            var addressStart = null;
            if (indexes.length !== 0 && nodes[i].textContent.length !== 0) addressStart = $.getSelector(nodes[i], true);else if (nodes[i].previousSibling !== null) addressStart = $.getSelector(nodes[i].previousSibling, true); // Find boundary ends
            ...
            for (var a = 0; a < indexes.length; a++) {
              ...
              if (innerHTML[a]) {
                ...
                if (a + 1 < indexes.length) addressStart = $.getSelector(textNode, true);
          ...
          if (innerHTML === '' && indexes.length === 1) temp.direct = indexes[0];else {
    ...
    self.queuePreprocess = function (targetNode, extracting, collectOther, temp) {
      ...
      for (var i = childNodes.length - 1; i >= 0; i--) {
        ...
        if (excludes[currentNode.nodeName] !== void 0) continue;

        if (currentNode.nodeType === 1) {
          // Tag
          if (enclosedHTMLParse === true) continue; // Skip nested sf-model

          if (currentNode.tagName === 'SF-M' || currentNode.sf$controlled) continue;
          var attrs = currentNode.attributes; // Skip element and it's childs that already bound to prevent vulnerability

          if (attrs['sf-bind-list'] !== void 0) continue;
          ...
          if (attrs['sf-into'] !== void 0 || attrs['sf-bind'] !== void 0) collectOther.input.push(currentNode); // Skip nested component

          if (internal.component[currentNode.tagName] !== void 0) continue;
          ...
          if (enclosing !== -1) enclosedHTMLParse = false;else if (enclosedHTMLParse === true) continue; // Start enclosed if closing pattern was found

          var enclosed = currentNode.textContent.indexOf(']}');

          if (enclosed !== -1 && (enclosing === -1 || enclosing > enclosed)) {
            // avoid {[ ... ]}
          ...
          if (currentNode.nodeValue.indexOf('{{') !== -1) {
            if (extracting === void 0) {
              if (!temp.has(currentNode.parentNode)) temp.add(currentNode.parentNode);
              break;
            }

            if (!temp.has(currentNode)) temp.add(currentNode);
          }
        }
      }

      if (firstCall) return Array.from(temp);
    };
    ...
    self.parsePreprocess = function (nodes, model) {
      ...
      for (var a = 0; a < nodes.length; a++) {
        ...
        if (internal.modelPending[model] || self.root[model] === undefined) self(model);
        ...
        if (current.hasAttribute('sf-bind-ignore') === false) self.bindElement(current, model);else {
    ...
    function initBindingInformation(modelRef) {
      if (modelRef.sf$bindedKey !== void 0) return; // Element binding data
    ...
    var repeatedListBinding = internal.model.repeatedListBinding = function (elements, modelRef) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (!element.hasAttribute('sf-repeat-this')) continue;
        var script = element.getAttribute('sf-repeat-this');
        element.removeAttribute('sf-repeat-this');
        var refName = script.split(' in ');
        if (refName.length !== 2) return console.error("'", script, "' must match the pattern like `item in items`");
        if (modelRef[refName[1]] === void 0) modelRef[refName[1]] = []; // Enable element binding

        if (modelRef.sf$bindedKey === void 0) initBindingInformation(modelRef);
        if (modelRef.sf$bindedKey[refName[1]] === void 0) modelRef.sf$bindedKey[refName[1]] = null;
        ;
        ...
        (function () {
          ...
          Object.defineProperty(modelRef, refName[1], {
            ...
            set: function set(val) {
              if (val.length === 0) return RE.splice(0);
    ...
    /*#__PURE__*/
    function (_Array) {
      _inheritsLoose(RepeatedElement, _Array);

      function RepeatedElement(modelRef, element, refName, parentNode) {
        var _this2;

        if (modelRef.constructor === Number) return Array(modelRef) || _assertThisInitialized(_this2);
        var list = modelRef[refName[1]];
        _this2 = _Array.call(this, list.length) || this;
        ...
        var isComponent = internal.component[element.tagName] !== void 0 ? window['$' + capitalizeLetters(element.tagName.toLowerCase().split('-'))] : false;
        var template;

        if (!isComponent) {
          element.setAttribute('sf-bind-list', refName[1]); // Get reference for debugging

          processingElement = element;
          template = self.extractPreprocess(element, refName[0], modelRef);
        }

        hiddenProperty(_assertThisInitialized(_this2), '$EM', new ElementManipulator());
        _this2.$EM.template = isComponent || template;
        _this2.$EM.list = _assertThisInitialized(_this2);
        _this2.$EM.parentNode = parentNode;
        _this2.$EM.modelRef = modelRef;
        _this2.$EM.refName = refName; // Update callback

        _this2.$EM.callback = callback;
        ...
        function injectElements(tempDOM, beforeChild) {
          for (var i = 0; i < that.length; i++) {
            if (isComponent) {
              var elem = new isComponent(that[i]); // elem.setAttribute('sf-bind-list', refName[1]);
            } else {
              var elem = templateParser(template, that[i], false, that.modelRef);
              syntheticCache(elem, template, that[i]);
            }

            if (beforeChild === void 0) tempDOM.appendChild(elem);else {
        ...
        if (parentNode.classList.contains('sf-virtual-list')) {
          ...
          hiddenProperty(_assertThisInitialized(_this2), '$virtual', {});
          if (!alone) console.warn("Virtual list was initialized when the container has another child that was not sf-repeated element.", parentNode);
          var tempDOM = document.createElement('div');
          injectElements(tempDOM); // Transfer virtual DOM

          _this2.$virtual.dom = tempDOM;
          _this2.$virtual.callback = callback; // Put the html example for obtaining it's size

          parentNode.replaceChild(template.html, parentNode.children[1]);
          internal.virtual_scroll.handle(_assertThisInitialized(_this2), parentNode);
          template.html.remove(); // And remove it
        } else if (alone) {
          // Output to real DOM if not being used for virtual list
          injectElements(parentNode);
          _this2.$EM.parentChilds = parentNode.children;
        } else {
          _this2.$EM.bound_end = document.createComment('');
          _this2.$EM.bound_start = document.createComment('');
          parentNode.insertBefore(_this2.$EM.bound_start, element);
          parentNode.insertBefore(_this2.$EM.bound_end, element);
          _this2.$EM.elements = Array(_this2.length); // Output to real DOM if not being used for virtual list

          injectElements(parentNode, _this2.$EM.bound_end);
        }

        element.remove(); // Wait for scroll plugin initialization

        setTimeout(function () {
          var scroller = internal.findScrollerElement(parentNode);
          if (scroller === null) return;
          var computed = getComputedStyle(scroller);
          if (computed.backfaceVisibility === 'hidden' || computed.overflow.indexOf('hidden') !== -1) return;
          scroller.classList.add('sf-scroll-element');
          internal.addScrollerStyle();
        }, 1000); // Todo: Enable auto item binding

        return _this2;
      }

      var _proto2 = RepeatedElement.prototype;
      ...
      _proto2.push = function push() {
        ...
        if (arguments.length === 1) this.$EM.append(lastLength);else {
      ...
      _proto2.splice = function splice() {
        ...
        var lastLength = this.length;
        Array.prototype.splice.apply(this, arguments); // Removing data
        ...
        if (this.$virtual && this.$virtual.DOMCursor >= real) this.$virtual.DOMCursor = real - limit;

        if (arguments.length >= 3) {
          // Inserting data
          limit = arguments.length - 2; // Trim the index if more than length

          if (real >= this.length) real = this.length - 1;

          for (var i = 0; i < limit; i++) {
            this.$EM.insertAfter(real + i);
          }

          if (this.$virtual && this.$virtual.DOMCursor >= real) this.$virtual.DOMCursor += limit;
        }
      };
      ...
      _proto2.unshift = function unshift() {
        Array.prototype.unshift.apply(this, arguments);
        if (arguments.length === 1) this.$EM.prepend(0);else {
      ...
      _proto2.replace = function replace(newList, atMiddle) {
        var lastLength = this.length;
        if (this.$virtual) this.$virtual.resetViewport(); // Check if item has same reference
        ...
        Array.prototype.splice.apply(this, temp); // Rebuild all element
        ...
        if (arguments[1] !== true) {
          ...
          this.$EM.hardRefresh(0);
            ...
            if (this.length < lastLength) this.$EM.removeRange(this.length, lastLength); // And start refreshing

            this.refresh(0, this.length);
            if (this.$virtual && this.$virtual.refreshVirtualSpacer) this.$virtual.refreshVirtualSpacer(this.$virtual.DOMCursor);
          } // Reset virtual this


        if (this.$virtual) this.$virtual.reset();
        return this;
      };

      _proto2.swap = function swap(i, o) {
        if (i === o) return;
        this.$EM.swap(i, o);
        var temp = this[i];
        this[i] = this[o];
      ...
      _proto2.move = function move(from, to, count) {
        if (from === to) return;
        if (count === void 0) count = 1;
        this.$EM.move(from, to, count);
        var temp = Array.prototype.splice.apply(this, [from, count]);
        temp.unshift(to, 0);
        Array.prototype.splice.apply(this, temp); // Reset virtual ceiling and floor

        if (this.$virtual) this.$virtual.reinitCursor();
      };

      _proto2.getElement = function getElement(index) {
        if (this.$virtual) {
          ...
          if (index >= this.$virtual.DOMCursor) {
            ...
            if (index < childElement) return this.$EM.parentNode.children[index + 1];else return virtualChilds[index - childElement + this.$virtual.DOMCursor];
          }

          return virtualChilds[index];
        }

        if (this.$EM.elements) return this.$EM.elements[index];
        return this.$EM.parentChilds[index];
      };

      _proto2.refresh = function refresh(index, length, property) {
        if (index === void 0 || index.constructor === String) {
          property = index;
          index = 0;
          length = this.length;
        } else if (length === void 0) length = index + 1;else if (length.constructor === String) {
          property = length;
          length = index + 1;
        } else if (length < 0) length = this.length + length;else length += index; // Trim length
        ...
        for (var i = index; i < length; i++) {
          var elem = this.getElement(i); // Create element if not exist

          if (elem === void 0) {
            this.$EM.hardRefresh(i || 0);
            if (this.$virtual) this.$virtual.DOMCursor = i || 0;
            break;
          } else if (syntheticTemplate(elem, this.$EM.template, property, this[i]) === false) continue; // Continue if no update


          if (elem.model !== this[i]) elem.model = this[i];
          if (this.$EM.callback.update) this.$EM.callback.update(elem, 'replace');
        }
      };

      _proto2.hardRefresh = function hardRefresh(i, o) {
        this.$EM.update(i, o);
        if (this.$virtual && this.$virtual.DOMCursor) this.$virtual.reinitCursor();
      };
    ...
    function () {
      ...
      var _proto3 = ElementManipulator.prototype;

      _proto3.createElement = function createElement(index) {
        var item = this.list[index];
        if (item === void 0) return;
        var template = this.template;
        if (template.constructor === Function) return new template(item);else {
      ...
      _proto3.virtualRefresh = function virtualRefresh() {
        var that = this;
      ...
      _proto3.hardRefresh = function hardRefresh(index) {
        var list = this.list;
        ...
        var exist = this.parentChilds || this.elements || this.virtualRefresh(); // Clear siblings after the index

        for (var i = index; i < exist.length; i++) {
          exist[i].remove();
        }

        if (list.$virtual) var vCursor = list.$virtual.vCursor;
        ...
        for (var i = index; i < list.length; i++) {
          ...
          if (this.list.$virtual) {
            if (vCursor.floor === null && i < vEndRange) this.parentNode.insertBefore(temp, this.parentNode.lastElementChild);else list.$virtual.dom.appendChild(temp);
          } else this.parentNode.appendChild(temp);
        }

        if (list.$virtual && list.$virtual.refreshVirtualSpacer) list.$virtual.refreshVirtualSpacer(list.$virtual.DOMCursor);
      };

      _proto3.move = function move(from, to, count) {
        if (this.list.$virtual) {
        ...
        if (theParent === false) {
          if (this.list.$virtual && this.list.length >= vEndRange) theParent = this.list.$virtual.dom;else theParent = parentNode;
        } // Move to defined index


        for (var i = 0; i < count; i++) {
          theParent.insertBefore(vDOM.firstElementChild, nextSibling);
          if (this.callback.update) this.callback.update(exist[from + i], 'move');
        }
      };

      _proto3.swap = function swap(index, other) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
      ...
      _proto3.remove = function remove(index) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
        ...
        if (exist[index]) {
          ...
          if (this.callback.remove) {
            ...
            if (!this.callback.remove(currentEl, startRemove)) startRemove();
          } // Auto remove if no callback
          else currentEl.remove();
        }
      };

      _proto3.update = function update(index, other) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
        var list = this.list;
        var template = this.template;
        ...
        if (index === void 0) {
          index = 0;
          other = list.length;
        } else if (other === void 0) other = index + 1;else if (other < 0) other = list.length + other;else other += index; // Trim length
        ...
        for (var i = index; i < other; i++) {
          ...
          if (oldChild === void 0 || list[i] === void 0) break;
          ...
          if (this.callback.update) this.callback.update(temp, 'replace');
        }
      };

      _proto3.removeRange = function removeRange(index, other) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
      ...
      _proto3.clear = function clear() {
        ...
        if (this.list.$virtual) var spacer = [parentNode.firstElementChild, parentNode.lastElementChild];
        ...
        if (this.list.$virtual) {
          ...
          spacer[1].style.height = spacer[0].style.height = 0;
          this.list.$virtual.reset(true);
        }
      };

      _proto3.insertAfter = function insertAfter(index) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
        var temp = this.createElement(index);
        if (exist.length === 0) this.parentNode.insertBefore(temp, this.parentNode.lastElementChild);else {
          var referenceNode = exist[index - 1];
          referenceNode.parentNode.insertBefore(temp, referenceNode.nextSibling);
        }
        if (this.callback.create) this.callback.create(temp);
      };

      _proto3.prepend = function prepend(index) {
        var exist = this.parentChilds || this.elements || this.virtualRefresh();
        var temp = this.createElement(index);
      ...
      _proto3.append = function append(index) {
        var list = this.list;
        ...
        if (list.$virtual) {
          if (index === 0) // Add before virtual scroller
            this.parentNode.insertBefore(temp, this.parentNode.lastElementChild);else if (index >= vEndRange) {
            // To virtual DOM
            if (list.$virtual.vCursor.floor === null) list.$virtual.vCursor.floor = temp;
      ...
      _proto3.replace = function replace(index) {
        var list = this.list;
        ...
        for (var i = 0; i < elRef.length; i++) {
          if (elRef[i].textContent === void 0 || elRef[i].ref.direct === void 0) continue;

          if (process.indexOf(elRef[i].ref.direct) !== -1) {
            var ref = elRef[i].textContent;
            var content = $.escapeText(list[index][key]).replace(needle, func); // Skip if nothing was changed

            if (list[index][key] === content) continue;
            ref.textContent = ''; // Let this empty for later referencing

            ref.sf$haveChilds = true;
            content = $.parseElement(content, true); // Remove old element if exist
    ...
    var templateExec = function templateExec(parse, item, atIndex) {
      var parsed = {};
      var temp = null; // Get or evaluate static or dynamic data

      for (var i = 0; i < parse.length; i++) {
        if (atIndex !== void 0 && atIndex.indexOf(i) === -1) continue;
        var ref = parse[i];
        ref.data[1] = item; // Direct evaluation type

        if (ref.type === REF_DIRECT) {
          temp = localEval.apply(self.root, ref.data);
          if (temp === void 0) temp = ''; // console.error('`'+ref.data[0]+'` was not defined');
          else {
              if (temp.constructor === Object) temp = JSON.stringify(temp);
              if (temp.constructor !== String) temp = String(temp);
            }
          parsed[i] = {
            type: ref.type,
            data: temp
    ...
    var templateParser = internal.model.templateParser = function (template, item, original, modelRef) {
      ...
      for (var i = 0; i < addresses.length; i++) {
        ...
        if (ref.nodeType === 1) {
          ...
          for (var a = 0; a < refA.length; a++) {
            var refB = refA[a]; // Pass to event handler
            ...
            var isValueInput = refB.name === 'value' && (current.tagName === 'TEXTAREA' || current.tagName === 'INPUT' && /checkbox|radio|hidden/.test(current.type) === false);
      ...
      html.model = item; // Save reference to element

      html.sf$elementReferences = changesReference; // html.sf$modelParsed = parsed;
      // Run the pending element

      for (var i = 0; i < pendingInsert.length; i++) {
        var ref = pendingInsert[i];
        var tDOM = parsed[ref.direct].data; // Check if it's an HTMLElement
    ...
    function syntheticCache(element, template, item) {
      if (element.sf$cache === void 0) element.sf$cache = {};
    ...
    function syntheticTemplate(element, template, property, item) {
      ...
      if (property !== void 0) {
        ...
        if (cache) for (var i = 0; i < modelRef_array.length; i++) {
          var ref = modelRef_array[i];
          if (ref[0] !== property) continue;
          var newData = deepProperty(item, ref[1]); // Check if data was different

          if (cache[ref[0]] !== newData) cache[ref[0]] = newData;
        }
      } else {
        var changes = [];
      ...
      function checkRelatedChanges(parseIndex) {
        ...
        if (found === false) return false; // Prepare all required data

        var changes_ = [];

        for (var i = 0; i < parseIndex.length; i++) {
          if (parsed[parseIndex[i]] === void 0) changes_.push(parseIndex[i]);
        }
      ...
      for (var i = 0; i < changesReference.length; i++) {
        ...
        if (cRef.dynamicFlag !== void 0) {
          ...
          if (parsed[cRef.direct] !== void 0) {
            ...
            var notExist = false; // Replace if exist, skip if similar
            ...
            for (var a = 0; a < tDOM.length; a++) {
              ...
              if (currentDOM[a].isEqualNode(tDOM[a]) === false) cRef.parentNode.replaceChild(tDOM[a], currentDOM[a]);
            } // Add if not exist
        ...
        if (cRef.textContent !== void 0) {
          ...
          if (parsed[cRef.ref.direct]) {
            ...
            var ref_ = cRef.textContent; // Remove old element if exist
  ...
  sf.API = function (method, url, data, _success, complete, accessToken, getXHR) {
    var type = typeof data;
    if (type !== 'object' && type !== 'function') data = {};
    var req = {
      url: url,
      dataType: 'json',
      method: 'POST',
      success: function success(obj) {
        if (!sf.API.onSuccess(obj) && _success) _success(obj, url);
    ...
    if (data.constructor !== FormData) req.contentType = "application/json";
    ...
    } else if (getXHR !== void 0) req.beforeSend = getXHR;
  ...
  var extendsAPI = {
    get: function get(url, data, success, complete) {
      return sf.API('get', this.url + url, data, success, complete, this.accessToken);
    },
    post: function post(url, data, success, complete) {
      return sf.API('post', this.url + url, data, success, complete, this.accessToken);
    },
    delete: function _delete(url, data, success, complete) {
      return sf.API('delete', this.url + url, data, success, complete, this.accessToken);
    },
    put: function put(url, data, success, complete) {
      return sf.API('put', this.url + url, data, success, complete, this.accessToken);
    },
    upload: function upload(url, formData, success, complete, progress) {
      if (formData.constructor !== FormData) return console.error("Parameter 2 must be a FormData");
      var getXHR = void 0;

      if (progress !== void 0) {
        getXHR = function getXHR(xhr) {
  ...
  sf.controller = new function () {
    ...
    self.for = function (name, func) {
      ...
      if (self.active[name]) return func();
    ...
    self.modelElement = function (element) {
      if (element.nodeType === 1 && element.sf$controlled !== void 0) return element;
    ...
    self.modelName = function (element) {
      ...
      name = name.sf$controlled; // Initialize it first

      if (name !== void 0 && !self.active[name]) self.run(name);
      return name;
    };

    self.run = function (name, func) {
      if (sf.component.registered[name]) return console.error("'" + name + "' is registered as a component");
      ...
      if (self.pending[name]) {
        ...
        if (i !== -1) internal.controller.pending.splice(i, 1);
      }

      if (sf.model.root[name] === void 0) sf.model.root[name] = {};
  ...
  */
  ...
  function Request(requestOptions) {
    ...
    if (proceedRequest === false) return void 0; // For jQuery guys
  ...
  function RequestShortcut(method) {
    ...
    [success, error].forEach(function (callback) {
      if (typeof callback === 'string') {
        dataType = callback;
        if (callback === success) success = void 0;else error = void 0;
      }
    });
  ...
  sf.events = function () {
    ...
    function Events(name, run) {
      ...
      if (Events[name] === void 0) {
        var active = void 0;
        if (run !== void 0 && run.constructor === Boolean) active = run;
        ...
        if (active !== void 0) {
          ...
          Events[name] = function () {
            for (var i = 0; i < callback.length; i++) {
              try {
                ...
                if (callback[i].once === true) callback.splice(i--, 1);
              } catch (e) {
                console.error(e);
              }
            }
          ...
          if (callbacks[name] === void 0) callbacks[name] = [];
    ...
    Events.when = function (name, callback) {
      if (Events[name] === true) return callback();
      if (callbacksWhen[name] === void 0) callbacksWhen[name] = [];
    ...
    Events.on = function (name, callback) {
      if (callbacks[name] === void 0) callbacks[name] = [];
      if (callbacks[name].length >= self.warningWhen) console.warn("Events", name, "have more than", self.warningWhen, "callback, there may possible memory leak.");
      callbacks[name].push(callback);
    };

    Events.off = function (name, callback) {
      if (callbacks[name] === void 0) return callbacks[name].length = 0;
  ...
  (function () {
    ...
    self.add = function (lang, obj) {
      if (self.list[lang] === void 0) self.list[lang] = {};
    ...
    function interpolate(text, obj) {
      return text.replace(interpolate_, function (full, match) {
        if (obj[match] !== void 0) return obj[match].constructor === Function ? obj[match]() : obj[match];
        if (self.interpolate[match] !== void 0) return self.interpolate[match].constructor === Function ? self.interpolate[match]() : self.interpolate[match];
        return full;
      });
    }
    ...
    self.get = function (path, obj, callback) {
      ...
      if (path.constructor === String) return getSingle(path, obj, callback);else return getMany(path, obj, callback);
    };

    function startRequest() {
      if (pending === false) return; // Request to server after 500ms
        ...
        activeRequest = sf.ajax({
          ...
          success: function success(obj) {
            ...
            for (var i = 0; i < pendingCallback.length; i++) {
              if (pendingCallback[i].callbackOnly === void 0) pendingCallback[i](diveObject(defaultLang, pendingCallback[i].path));else pendingCallback[i]();
            }
    ...
    function getSingle(path, obj, callback) {
      ...
      if (value !== void 0) {
        if (obj) value = interpolate(value, obj);
    ...
    function getMany(paths, obj, callback) {
      ...
      for (var i = 0; i < paths.length; i++) {
        ...
        if (temp) value[paths[i]] = temp;else missing.push(paths[i]);
      }
      ...
      var callback_ = function callback_() {
        for (var i = 0; i < missing.length; i++) {
          var temp = diveObject(default_, missing[i]);
          if (temp) value[missing[i]] = temp;
        }
    ...
    function diveFill(obj1, obj2) {
      ...
      for (var i = 0; i < keys.length; i++) {
        var key = keys[i];
        if (obj1[key] === void 0) obj1[key] = obj2[key];else if (obj2[key].constructor === Object) diveFill(obj1[key], obj2[key]);
      }
    }
    ...
    self.init = function (el) {
      ...
      if (self.list[self.default] === void 0) self.list[self.default] = {};
      refreshLang(list);
      ...
      if (pending !== false && self.serverURL === false) console.warn("Some language was not found, and the serverURL was set to false");
    };
    ...
    function diveObject(obj, path, setValue) {
      ...
      for (var i = 0, n = parts.length - 1; i <= n; i++) {
        ...
        if (setValue === void 0) {
          ...
          if (obj[key] === void 0) obj = obj[key] = {};else obj = obj[key];
        }
      }
    ...
    function refreshLang(list, noPending) {
      ...
      for (var i = list.length - 1; i >= 0; i--) {
        ...
        if (noPending === true) list.splice(i, 1);
        if (elem.tagName === 'INPUT') elem.placeholder = value;else elem.textContent = value;
  ...
  (function () {
    ...
    self.data = {};
    self.paths = '/'; // Push into latest history
    ...
    self.get = function (name, index) {
      self.parse();
      if (name.constructor === Number) return self.paths.split('/')[name + 1];
      if (hashes[name] === void 0) return;
  ...
  (function () {
    ...
    var rejectResponse = /<html/; // Save reference
    ...
    window.addEventListener('popstate', function (ev) {
      ...
      if (window.history.state >= historyIndex) routeDirection = 1;else routeDirection = -1;
      historyIndex += routeDirection; // console.warn('historyIndex', historyIndex, window.history.state, routeDirection > 0 ? 'forward' : 'backward');
      // Reparse URL

      self.goto();
      disableHistoryPush = false;
    }, false); // Listen to every link click
    ...
    sf(function () {
      $.on(document.body, 'click', 'a[href]', function (ev) {
        ...
        if (attr[0] === '@') {
          ...
          if (target) window.open(attr.slice(1), target);else window.location = attr.slice(1);
          return;
    ...
    internal.router.parseRoutes = function (obj_, selectorList) {
      ...
      function addRoutes(obj, addition, selector, parent) {
        ...
        for (var i = 0; i < obj.length; i++) {
          ...
          if (ref.routes !== void 0) addRoutes(ref.routes, current, selector, parent);
          ...
          if (ref.url !== void 0) route.url = ref.url;else if (ref.templateURL !== void 0) route.templateURL = ref.templateURL;else if (ref.html !== void 0) {
            // Create new element
            var dom = route.html = document.createElement('sf-page-view');
            if (ref.html.constructor === String) dom.innerHTML = ref.html;else dom.appendChild(ref.html);
          ...
          if (parent !== void 0) route.parent = parent;
          if (ref.on !== void 0) route.on = ref.on;
          if (ref.cache) route.cache = true;
          var hasChild = [];
          var keys = Object.keys(ref);

          for (var a = 0; a < keys.length; a++) {
            if (knownKeys.test(keys[a])) continue;
    ...
    var self = sf.views = function View(selector, name) {
      if (name === void 0) name = slash;
      var self = this;

      if (name) {
        if (sf.views.list[name] === void 0) sf.views.list[name] = [];
        sf.views.list[name].push(self);
      }

      var pendingAutoRoute = false; // Init current URL as current View Path

      if (name === slash) self.currentPath = sf.url.paths;else if (name === false) self.currentPath = '';else {
        self.currentPath = '';
      ...
      self.selector = function (selector_, isChild, currentPath) {
        ...
        if (collection === null) collection = DOM.getElementsByTagName('sf-page-view'); // Create listener for link click

        if (DOM) {
          if (selector_) selector = selector_;
          var temp = null; // Bring the content to an sf-page-view element

          if (DOM.childNodes.length !== 0) {
            if (DOM.childNodes.length === 1 && DOM.firstChild.nodeName === '#text' && DOM.firstChild.textContent.trim() === '') DOM.firstChild.remove();else {
      ...
      self.on = function (event, func) {
        if (onEvent[event] === void 0) return console.error("Event '" + event + "' was not exist");
      ...
      self.addRoute = function (obj) {
        ...
        if (!initialized) self.selector();

        if (!firstRouted && name) {
          sf(function () {
            if (firstRouted) return;
            ...
            if (pendingAutoRoute) {
              if (aHashes[name] !== void 0) firstRouted = self.goto(aHashes[name]);else firstRouted = self.goto('/');
              if (firstRouted) pendingAutoRoute = false;
            }
          });
        }
      };
      ...
      function findRelatedElement(currentURL) {
        ...
        for (var i = 0; i < collection.length; i++) {
          if (currentURL.indexOf(collection[i].routePath) === 0) found.push(collection[i]);
        }
      ...
      function findCachedURL(currentURL) {
        for (var i = collection.length - 1; i >= 0; i--) {
          // Search from deep view first
          if (currentURL === collection[i].routePath) return collection[i];
        }
      ...
      function toBeShowed(element, event, path, data) {
        ...
        while (parent !== rootDOM && parent !== null) {
          if (parent.nodeName === pageViewNodeName) relatedPage.unshift(parent);
        ...
        for (var i = 0; i < relatedPage.length; i++) {
          if (showedSibling === void 0 && relatedPage[i].parentNode === parentSimilarity) showedSibling = relatedPage[i];
      ...
      self.goto = function (path, data, method, _callback) {
        if (self.currentPath === path) return; // Get template URL

        var url = routes.findRoute(path);
        if (!url) return; // Return when beforeRoute returned truthy value

        if (url.beforeRoute !== void 0 && url.beforeRoute(url.data)) return;
        if (name === slash) sf.url.paths = path;else if (name) aHashes[name] = path; // This won't trigger popstate event

        if (!disableHistoryPush && !_callback) sf.url.push(); // Check if view was exist

        if (!rootDOM.isConnected) {
          if (rootDOM.nodeType !== void 0) rootDOM = {};
          if (!self.selector()) ;
        ...
        if (RouterLoading) RouterLoading.abort(); // Return if the cache was exist
        ...
        function insertLoadedElement(DOMReference, dom, parentNode, pendingShowed) {
          if (parentNode) dom.parentPageElement = parentNode;
          dom.routerData = {};
          ...
          setTimeout(function () {
            ...
            // sf.model.init(dom);
            if (url.on !== void 0 && url.on.coming) url.on.coming(self.data);
            if (url.cache) dom.routeNoRemove = true;
            var tempDOM = self.currentDOM;
            self.currentDOM = dom;
            toBeShowed(dom); // Trigger loaded event
            ...
            if (pendingShowed !== void 0) self.relatedDOM.push.apply(self.relatedDOM, pendingShowed);

            if (tempDOM !== null) {
              self.lastPath = self.currentPath; // Old route

              if (tempDOM.routeCached && tempDOM.routeCached.on !== void 0 && tempDOM.routeCached.on.leaving) tempDOM.routeCached.on.leaving(path, url);
            ...
            routingError = false; // Clear old cache

            var parent = self.currentDOM.parentNode;

            for (var i = parent.childElementCount - self.maxCache - 1; i >= 0; i--) {
              if (parent.defaultViewContent !== parent.firstElementChild && parent.firstElementChild.routeNoRemove) parent.firstElementChild.remove();else if (parent.childElementCount > 1) parent.firstElementChild.nextElementSibling.remove();
            }
          });
        }

        var afterDOMLoaded = function afterDOMLoaded(dom) {
          if (url.selector || url.hasChild) {
            var selectorElement = dom.sf$viewSelector;
            if (selectorElement === void 0) selectorElement = dom.sf$viewSelector = {};
          }
          ...
          if (url.hasChild) {
            ...
            for (var i = 0; i < url.hasChild.length; i++) {
              ...
              if (tempPageView) pendingShowed.unshift(tempPageView);
            }

            if (pendingShowed.length === 0) pendingShowed = void 0;
          } else var pendingShowed = void 0;

          if (url.selector === void 0) var DOMReference = rootDOM;else {
            // Get element from selector
            var selectorName = selectorList[url.selector];
            var DOMReference = null;
            var last = findRelatedElement(path); // Find current parent

            for (var i = 0; i < last.length; i++) {
              var found = last[i].sf$viewSelector;
              if (found === void 0 || found[selectorName] === void 0) continue;
            ...
            if (!DOMReference || !DOMReference.isConnected) {
              if (url.parent === void 0) {
                ...
                return self.goto(newPath, false, method, function (parentNode) {
                  ...
                  if (defaultViewContent.routePath !== path) defaultViewContent.classList.remove('page-current');
                });
              }
            }
          }
        ...
        RouterLoading = sf.ajax({
          ...
          success: function success(html_content) {
            ...
            dom.classList.add('page-prepare'); // Same as above but without the component initialization
      ...
      function tryCache(path) {
        ...
        function findDOM(dom) {
          ...
          if (cachedDOM) return true;
          var childs = dom.children;

          for (var i = 0; i < childs.length; i++) {
            if (childs[i].routePath === path) {
              cachedDOM = childs[i]; // console.warn('cache found for', path, childs[i]);
        ...
        if (findDOM(rootDOM) === false) for (var i = 0; i < selectorList.length; i++) {
          if (findDOM(rootDOM.querySelector(selectorList[i]))) break;
        }
        if (cachedDOM === false) return false;
        if (self.currentDOM.routeCached.on !== void 0 && self.currentDOM.routeCached.on.leaving) self.currentDOM.routeCached.on.leaving();
        self.currentDOM = cachedDOM;
        self.data = cachedDOM.routerData;
        if (self.currentDOM.routeCached.on !== void 0 && self.currentDOM.routeCached.on.coming) self.currentDOM.routeCached.on.coming();
    ...
    self.goto = function (url) {
      ...
      var list = self.list; // For root path

      if (list[slash] !== void 0) {
        var ref = list[slash];

        for (var a = 0; a < ref.length; a++) {
          if (ref[a].currentPath !== parsed.paths) ref[a].goto(parsed.paths);
        }
      } // For hash path
      ...
      for (var i = 0; i < view.length; i++) {
        ...
        for (var a = 0; a < ref.length; a++) {
          if (ref[a].currentPath !== parsed.hashes[view[i]]) ref[a].goto(parsed.hashes[view[i]]);
        }
      }
    };
  })();
  ...
  internal.virtual_scroll = new function () {
    ...
    self.handle = function (list, parentNode) {
      ...
      virtual.resetViewport = function () {
        ...
        if (virtual.preparedLength < 18) virtual.preparedLength = 18;
      };

      setTimeout(function () {
        if (!list.$virtual || !parentNode.isConnected) return; // Somewhat it's uninitialized
    ...
    function dynamicHeight(list, parentNode, scroller) {
      ...
      virtual.scrollTo = function (index) {
        scrollTo(index, list, self.prepareCount, parentNode, scroller); // Reset virtual spacer height
      ...
      function checkCursorPosition() {
        ...
        if (list.length !== 0) {
          if (virtual.callback.hitFloor && virtual.vCursor.floor === null && scroller.scrollTop + scroller.clientHeight === scroller.scrollHeight) {
        ...
        updating = false;
        if (scroller.scrollTop === 0 && ceiling.offsetHeight > 10) virtual.scrollTo(0);
      }

      scroller.addEventListener('scroll', checkCursorPosition, {
        capture: true,
        passive: true
      });
    ...
    function staticHeight(list, parentNode, scroller) {
      ...
      function checkCursorPosition() {
        ...
        virtual.DOMCursor = cursor; // console.log(cursor, changes, bounding.ceiling, bounding.floor, scroller.scrollTop);
    ...
    function refreshScrollBounding(cursor, bounding, list, parentNode) {
      ...
      if (cursor < self.prepareCount) {
        ...
        if (bounding.floor !== void 0) bounding.floor = bounding.floor.offsetTop;else bounding.floor = parentNode.lastElementChild.offsetTop + 1000;
        bounding.floor -= bounding.initial;
        return;
      } else if (parentNode.children[temp + 1] !== void 0) bounding.ceiling = parentNode.children[temp + 1].offsetTop; // -2 element


      if (list.$virtual.preparedLength !== void 0 && cursor >= list.length - list.$virtual.preparedLength) bounding.floor = list.$virtual.dCursor.floor.offsetTop + list.$virtual.scrollHeight * 2;else {
        if (parentNode.childElementCount <= self.prepareCount + 3) return;
    ...
    function scrollTo(index, list, prepareCount, parentNode, scroller) {
      ...
      if (virtual.DOMCursor === 0 && index < prepareCount + prepareCount / 2 || virtual.DOMCursor + prepareCount / 2 > index && virtual.DOMCursor + prepareCount < index) scroller.scrollTop = list.getElement(index_).offsetTop; // Move cursor
      else {
          var temp = null;
          var ceiling = virtual.dCursor.ceiling;
          var floor = virtual.dCursor.floor;
          ...
          if (list.$virtual.refreshVirtualSpacer) list.$virtual.refreshVirtualSpacer(index);
          refreshScrollBounding(index, virtual.bounding, list, parentNode);
          temp = parentNode.children[prepareCount - reduce + 1];
          if (temp !== void 0) scroller.scrollTop = temp.offsetTop - scroller.offsetTop;
        }
    ...
    function refresh(force, list, prepareCount, parentNode, scroller, checkCursorPosition, refreshVirtualSpacer) {
      ...
      if (force || parentNode.childElementCount - 2 > list.$virtual.preparedLength) {
        ...
        scrollTo(moveTo, list, prepareCount, parentNode, scroller);
      ...
      if (_onElementResize_timer === -1) {
        _onElementResize_timer = setInterval(function () {
          ...
          for (var i = _onElementResize.length - 1; i >= 0; i--) {
            temp = _onElementResize[i]; // Check if it's removed from DOM
            ...
            if (temp.element.scrollHeight === temp.height || temp.element.scrollWidth === temp.width) continue;
            temp.callback();
          }
...
//# sourceMappingURL=scarletsframe.min.1573191750813.js.map
